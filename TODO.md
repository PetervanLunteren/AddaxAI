...
- [ ] I think we need to rethink our frames storage plan. Now that we have separated counts and labels as separate steps, you can get this problem (which is already a problem on my very limited dataset). Imagine:
              - Process videos
              - in label cleanup step we only see the crops of the best frames: http://localhost:5173/folder-runs/be5390ef-f797-485c-81bd-1a5352a62e37/labels
              - in counts step we see the labels of all the frames: http://localhost:5173/folder-runs/be5390ef-f797-485c-81bd-1a5352a62e37/counts
