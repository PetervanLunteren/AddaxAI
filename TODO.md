...
- [ ] It would be cool if we could zoom in (read: set start and end date) by clicking and dragging on the /insights/timeline graph. Would that be difficult to do? No worries if you dont think its feasible. This is just a nice-to-have, not manadatory. KISS. 
