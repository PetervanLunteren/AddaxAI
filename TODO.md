...
SHould we add the map to the plots section too as nested page? Then probabaly rename the nested "plots" to something like "insights" or "Analyses". What do you think? 
