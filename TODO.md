...
- There is a real heuristic we need to talk about. Lerts imagine an event of two indiviuals. Thiosae individuals are phtographed 9 times. MOst of the times the AI got both animals, sometimes it missed the further back one. BUT, it identified the animals as B. taurus 13 out of 14 times, and the background one is labelled Bovidae once. The count modal gives the AI sugegstion "B taurius x2, Bovidae x1". What do we think of this? SHould we limit the AI prediction to the MaxN always? Otherwise you get a very large AI suggestion once you have a flock of deer that are sometimes mislabeld. What do you think? And what would be the heuristics? 
