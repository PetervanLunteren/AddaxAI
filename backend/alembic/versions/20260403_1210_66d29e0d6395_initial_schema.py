...
Revision ID: 66d29e0d6395
Revises:
Create Date: 2026-04-03 12:10:13.847730
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_label_taxonomy_model", "label_taxonomy", ["classification_model_id"], unique=False
    )
    ...
    op.create_index(
        "idx_detections_label_confidence", "detections", ["label_confidence"], unique=False
    )
    op.create_index(
        "idx_detections_label_taxonomy", "detections", ["label_taxonomy_id"], unique=False
    )
    ...
    op.create_index(
        "idx_event_obs_label_taxonomy", "event_observations", ["label_taxonomy_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        "idx_detection_embeddings_detection", "detection_embeddings", ["detection_id"], unique=False
    )
    op.create_index(
