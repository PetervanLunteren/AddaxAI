...
# and never reaches results.json, the database, or the smoother. Both
# the main app worker (`app/workers/detection_worker.py`) and the
# Timelapse runner (`app/ml/timelapse_runner.py`) pass this value to
# detect_to_json and to the postprocessing smoother.
#
...
#
# To change the global floor, edit this constant. Both the main app
# and Timelapse mode follow automatically. Don't reintroduce literal
# 0.1 in call sites.
