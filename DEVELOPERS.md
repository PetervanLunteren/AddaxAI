...
| Module | How |
|--------|-----|
| `services/crop_service.py` | `_resolve_source`: the track's crop, else the cover when the card sits on it, else the frame decoded on request; `None` for a box that is not a card |
