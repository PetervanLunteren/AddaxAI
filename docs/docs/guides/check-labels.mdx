...
Most empty files do have a box, the AI just scored it too low to show you. Lower the detection confidence in More filters and those files move to Detections, where a cropped card is faster to judge than a whole frame. 
