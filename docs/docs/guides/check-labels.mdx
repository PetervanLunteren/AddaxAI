...
In Files, a video's tile shows its cover, one frame the AI picked as the picture for the clip, and reads "Video"; the chips on it count the animals followed. Opening it shows the cover with a timeline underneath: one row per species, one bar per animal. Click a bar to see that animal on its own frame and select it; click anywhere else on the timeline to see that moment. Mark false and Relabel then act on the animal you selected, every frame of it; with nothing selected they act on every animal in the clip. Verify signs off every animal in the clip, the same way it signs off every box in a photo. A box you draw is saved on the cover; an animal the AI missed later in the clip is added on the Counts page.
