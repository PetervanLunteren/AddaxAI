...
Choose the data type, camera trap or [underwater](./underwater-videos.mdx), then pick the folder and the models: a detector to find the animals, and a classifier to name the species. Start the run.
