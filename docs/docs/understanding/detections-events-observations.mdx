...
Long videos work differently when [Track animals across frames](../guides/underwater-videos.mdx) is on. AddaxAI then follows each animal through the clip, and every animal it followed is one card on the Labels page, shown at the frame where the AI saw it best. What you do with that card, a species, a verified tick, a rejection, applies to every frame the animal was followed through. The count per species is still the most animals visible together in one frame, now taken over the whole clip, and the Counts page shows you that frame.
